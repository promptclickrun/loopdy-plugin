...
`x-loopdy-capabilities: socket-ready-v1` capability to that signed upgrade
...
receipted as duplicates; conflicting or skipped new sequences remain rejected.
